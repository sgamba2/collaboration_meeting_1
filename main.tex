...
\institute[Unipi]{\centering\includegraphics[height=1cm]{FNAL-Logo-NAL-Blue.png}\hspace{10mm}\includegraphics[height=1.6cm]{figures/eps/cherubino.eps}}
\date[03/18/2024]{March 18th 2024}

\titlegraphic{\includegraphics[height=1.6cm]{mu2e_logo_oval.png}\hspace{1.4cm}}
\begin{document}
